...
KMVSS candidate per topic without any key. Article numbers are deliberately left
empty: they must come from the official text, not from memory.
...
SEED: list[KmvssTopic] = [
    ...
    KmvssTopic("braking", "제동장치 (브레이크 라이닝·패드 포함)",
               ("brake", "braking", "pad", "lining", "disc", "제동", "브레이크")),
    KmvssTopic("tyres", "타이어 및 타이어공기압경고장치",
               ("tyre", "tire", "tpms", "pressure", "타이어", "공기압")),
    KmvssTopic("wheels", "휠 (바퀴)", ("wheel", "rim", "alloy", "휠")),
    KmvssTopic("child_restraint", "어린이보호용 좌석부착장치 및 어린이 보호장치",
               ("child", "isofix", "booster", "i-size", "어린이", "카시트")),
    KmvssTopic("seat_belt", "좌석안전띠", ("seat belt", "belt", "안전띠", "안전벨트")),
    KmvssTopic("emc", "전자파 적합성 (전기·전자 장치)", ("emc", "electronic", "ecu", "sensor", "전자파", "전장")),
    KmvssTopic("glazing", "창유리 (안전유리)", ("glass", "glazing", "windshield", "유리")),
    KmvssTopic("mirror", "후사경 및 간접시계장치", ("mirror", "camera monitor", "후사경", "사이드미러")),
]
